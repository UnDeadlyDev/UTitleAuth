...
public class BossBarUtils {
    ...
    static {
        try {
            ...
            TitleAuth.get().sendLogMessage("An error occurred during NMS class initialization");
        }
    }
    ...
    public static void addBossBar(Player player, String text, float health) {
        try {
            ...
            TitleAuth.get().sendLogMessage("Failed to spawn a BossBar");
        }
    }
    ...
    public static void removeBossBar(Player player) {
        try {
            ...
            TitleAuth.get().sendLogMessage("Failed to destroy a BossBar");
        }
    }
    ...
    public static void updateTitle(Player player, String text) {
        try {
            ...
            TitleAuth.get().sendLogMessage("Failed to update BossBar title");
        }
    }
    ...
    public static void updateHealth(Player player, float health) {
        try {
            ...
            TitleAuth.get().sendLogMessage("Failed to update BossBar health");
        }
    }
    ...
    public static void move(Player player) {
        try {
            ...
            TitleAuth.get().sendLogMessage("Failed to move BossBar");
        }
    }
    ...
    private static void sendPacketToPlayer(Player player, Object packet) {
        try {
            ...
            TitleAuth.get().sendLogMessage("Failed to send packet to player ");
        }
    }
